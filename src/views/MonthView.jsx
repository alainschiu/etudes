...
export default function MonthView(p){
  ...
  const content = (<div>
    <div className="mb-12">
      ...
      <h1 className="leading-none" style={{fontFamily:serif,fontWeight:400,fontSize:'clamp(32px,6vw,56px)',letterSpacing:'-0.02em'}}><span style={{fontStyle:'italic'}}>{targetDate.toLocaleDateString('en-US',{month:'long'})}</span><span style={{color:FAINT}}>{` ${year}`}</span></h1>
