...
export default function MonthView(p){
  const {history,settings,monthActualSeconds,monthReflection,setMonthReflection,openLogEntry,effectiveTotalToday}=p;
  ...
  return (<div className="max-w-4xl mx-auto px-12 py-14">
    <div className="mb-12">
      ...
      <h1 className="leading-none" style={{fontFamily:serif,fontWeight:300,fontSize:'clamp(32px,6vw,56px)',letterSpacing:'-0.02em'}}><span style={{fontStyle:'italic'}}>{targetDate.toLocaleDateString('en-US',{month:'long'})}</span><span style={{color:FAINT}}>{` ${year}`}</span></h1>
