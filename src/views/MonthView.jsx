...
import {DisplayHeader, Ring, MarkdownField, SaveIndicator} from '../components/shared.jsx';

export default function MonthView(p){
  const {isMobile}=useViewport();
  const {history,settings,monthActualSeconds,monthReflection,setMonthReflection,openLogEntry,effectiveTotalToday,nested,onWikiLinkClick,wikiCompletionData,writeStatus}=p;
