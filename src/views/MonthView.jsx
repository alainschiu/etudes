...
export default function MonthView(p){
  const {history,settings,monthActualSeconds,monthReflection,setMonthReflection,openLogEntry,effectiveTotalToday,streak}=p;
