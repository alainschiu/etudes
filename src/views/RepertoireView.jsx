      ...
      {expanded&&(<div className="px-6 py-6" style={{background:SURFACE,borderTop:`1px solid ${LINE}`}}>
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-8">
            ...
            <LogBookPanel item={i} updateItem={updateItem} addNoteLogEntry={addNoteLogEntry} deleteNoteLogEntry={deleteNoteLogEntry} updateNoteLogEntry={updateNoteLogEntry} onWikiLinkClick={onWikiLinkClick}/>
          </div>
...
function LogBookPanel({item,updateItem,addNoteLogEntry,deleteNoteLogEntry,updateNoteLogEntry,onWikiLinkClick}){
      ...
      {tab==='info'&&(
        <div style={{padding:'0 20px 24px'}}>
          ...
          <div style={{padding:'20px 0'}}>
            ...
            <MarkdownField value={item.detail||''} onChange={v=>updateItem(item.id,{detail:v})} placeholder="Long-running notes…" minHeight={120} style={{background:SURFACE2,border:`1px solid ${LINE}`,fontSize:'15px'}} onWikiLinkClick={onWikiLinkClick}/>
          </div>
          {/* Delete */}
