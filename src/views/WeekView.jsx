...
export default function WeekView(p){
  const {history,settings,weekActualSeconds,weekReflection,setWeekReflection,effectiveTotalToday,openLogEntry}=p;
  ...
  return (<div className="max-w-4xl mx-auto px-12 py-14">
    <div className="mb-12">
      ...
      <h1 className="leading-none" style={{fontFamily:serif,fontWeight:300,fontSize:'clamp(32px,6vw,56px)',letterSpacing:'-0.02em',fontStyle:'italic'}}>{weekTitle}</h1>
