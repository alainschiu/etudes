...
export default function WeekView(p){
  ...
  const {history,settings,weekActualSeconds,weekReflection,setWeekReflection,effectiveTotalToday,openLogEntry,nested,onWikiLinkClick,wikiCompletionData,writeStatus}=p;
