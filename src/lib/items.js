...
export const makeNewItem=(type)=>({id:Date.now()+Math.floor(Math.random()*1000),type,title:'Untitled',tags:[],pdfs:[],defaultPdfId:null,detail:'',composer:'',author:'',arranger:'',catalog:'',collection:'',movement:'',stage:'learning',referenceUrl:'',startedDate:null,bpmLog:[],bpmTarget:null,todayNote:'',instrument:'',spots:[],performances:[],lengthSecs:null});
